    ...
    static class IRCColor {
        public static ITermColor getITermColor (int color) {
            switch (color) {
                ...
                case 5:
                    return new StaticSingleTermColorProvider (System.ConsoleColor.DarkRed); // close alternative
                case 6:
                ...
                case 13:
                    return new StaticSingleTermColorProvider (System.ConsoleColor.Red); // eh
                case 14:
                    return new StaticSingleTermColorProvider (System.ConsoleColor.Gray); // GREY
                case 15:
                    return new StaticSingleTermColorProvider (System.ConsoleColor.White);
                default:
